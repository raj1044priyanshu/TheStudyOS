...
import { clearAllTourStorage, queueForcedTour } from "@/lib/tour";
          ...
          <div className="rounded-[24px] border border-[color:var(--panel-border)] p-5">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <div className="mt-2 inline-flex items-center gap-2 text-[var(--foreground)]">
                  <IconSparkles className="h-5 w-5 text-[#7B6CF6]" />
                  <p className="font-headline text-[2rem]">{achievements.progress.levelName}</p>
                </div>
              </div>
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {visibleDefinitions.map((definition) => {
            ...
            return (
              ...
              >
                <div
                  className={`inline-flex h-12 w-12 items-center justify-center rounded-[18px] ${unlocked ? "" : "grayscale blur-[1px]"}`}
                  style={{ backgroundColor: `${definition.color}16`, color: definition.color }}
                >
      ...
      <div className="glass-card p-6">
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {[
            ...
            ["Checkpoint pass count", stats.passedCheckpoints],
            ["Most studied subject", stats.mostStudiedSubject],
            ["Average quiz score", `${stats.averageQuizScore}%`],
            ["Average checkpoint score", `${stats.averageCheckpointScore}%`],
